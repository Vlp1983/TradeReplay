      ...
      <div className="space-y-2">
        {moments.map((m, i) => {
          ...
          return (
            ...
            >
              <div
                className={`mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-surface ${color}`}
              >
